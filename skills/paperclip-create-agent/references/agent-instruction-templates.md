...
These templates are deliberately separate from the main Lovon Teams heartbeat skill and from `SKILL.md` in this folder — the core wake procedure and hiring workflow stay short, and role-specific depth lives here.
...
5. Keep the Lovon Teams heartbeat requirement and the task-comment requirement.
