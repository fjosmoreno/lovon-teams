...
- [ ] The first paragraph points at the Lovon Teams skill as the source of truth for the heartbeat procedure
...
- [ ] For execution-heavy roles (coders, operators, designers, security, QA), `AGENTS.md` includes the Lovon Teams execution contract verbatim:
...
- [ ] Adapter config matches this Lovon Teams instance (cwd, model, credentials) per `/llms/agent-configuration/<adapter>.txt`
