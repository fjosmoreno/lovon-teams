...
description: >
  Write the Discord release announcement for a stable Lovon Teams release. Companion
...
Write the Discord release announcement for the **stable** Lovon Teams release.
...
current Lovon Teams work — not invented.
...
TELL ME if you're using Lovon Teams in your business - I want to meet you
...
thousand agents and Lovon Teams will be the default tool to manage it all.
...
- **First person, conversational.** "I want to meet companies using Lovon Teams",
  "what's on my mind", "if that's you let me know". Not "Lovon Teams is excited
  to announce".
...
- **"What's on my mind"** is dotta's personal/strategic thinking — docs gaps,
  ...
  invitations ("if you've ever wanted to write about how you use Lovon Teams,
...
- **Community** is the same contributors list that's in the changelog file,
  ...
  Exclude bots and Lovon Teams founders, same rules as the changelog skill.
- **The "In Summary" mission line** evolves slowly. Use the most recent
  ...
  - "Lovon Teams will be _the_ control plane for AI agents in **every** company."
...
:thumbsup:  **Feedback and evals** - you can now vote :thumbsup: / :thumbsdown: on your agent's responses. If you choose to share your traces with me, I'll use it to make Lovon Teams better. In either case you can export locally for your own org's learning
:page_with_curl:  **Document revisions** - you can now restore old versions of your documents
:ping_pong:  **Telemetry** - this version has anonymized telemetry that helps me better understand the basic uses of Lovon Teams (adapters and so on) - if you hate that, just it disable with `DO_NOT_TRACK=1` or `PAPERCLIP_TELEMETRY_DISABLED=1` environment variables
:construction_worker: **Execution Workspaces (experimental)** - Lovon Teams is not a "code review" tool, but I have been finding worktrees are important for certain projects. Enable it in experimental settings
...
I've been doing my part to spread the word about Lovon Teams
...
* [Nevo made $76k in march](https://x.com/dotta/status/2039406772859920758) after using Lovon Teams to automate his marketing
* [Lewis Jackson](https://x.com/WhatSayLew/status/2039810227394978158) said 34 agents were already operating his trading firm through Lovon Teams and called it his "holy s***" AI moment.
* [Neal Kotak](https://x.com/nkotak1/status/2039582439459209638) said Lovon Teams already runs most of Roominary for him and praised how strong the product is.
* [Sam Woods](https://x.com/samwoods/status/2039039305960587755) said he knows several people who moved from OpenClaw to Lovon Teams, often with Hermes in the stack, and that they love it.
* [Josh Galt](https://x.com/JoshGalt/status/2039386307219095557) called Lovon Teams the coolest agent tooling he has used and said it is finally something that just works.

## IN SUMMARY

I know there are still some rough edges, but

Lovon Teams will be *the* control plane for AI agents in **every** company.
...
:no_smoking: Blocker dependencies - first-class "wake on blocker resolved" which means now you can have "task graphs" that depend on one another and it's enforced by Lovon Teams
...
* **Multi-human users** - in the last stages of testing, Lovon Teams is better with teams
* **Memory Infrastructure** - your agents will remember everything about yoru business
* **Sandbox execution** - run your agents anywhere

## What's on my mind

* I want to meet with companies who are using Lovon Teams in their business - if that's you let me know
* We need more Lovon Teams tutorials, defaults, and education - thanks to @aronprins for his work in this area already!
...
* We're adding better support for *knowledge (wikis & files)*, *artifacts*, and *work product* in Lovon Teams soon.

## PRESS

* **AI Engineer Europe Tutorial** - I gave a tutorial for AIE. If someone is looking for a basics ABC of Lovon Teams [you can send them this](https://x.com/dotta/status/2044575580264316931)
* **AI Club Chicago** - JB gave a talk on Lovon Teams [at AI Tinkerers in Chicago](https://x.com/developwithJB/status/2044281068778316268) !

## IN SUMMARY

PAPERCLIP WILL BE THE DEFAULT AGENT-MANAGEMENT TOOL FOR EVERY COMPANY

If there's anything I can do to help you and your company use Lovon Teams, hit me up. Until then, enjoy the new release
...
* **Longer-range planning and execution** - Lovon Teams will support longer and longer tasks and work until it's done
* **Secrets Service v2** - an important prereq for Lovon Teams cloud
...
* **Lovon Teams Cloud** - will be a critical unlock for us, but even the shared team story needs developed more - *where should the work be done* and *where are the outputs stored* and *how do we surface them to users*? Each of these questions are a core Lovon Teams service that needs developed
* **Lovon Teams Bench** - In the vein of SWE-Bench I've started an internal benchmark for Lovon Teams - we have to be able to measure that our changes are improving the system and not regressing
* **Lovon Teams Connections Store** - connecting to Github, Slack, Google Docs, and the hundreds of other services we use every day should be easy, secure, and configurable per agent and team

## Press

I met with the [Wisemen about Lovon Teams](https://x.com/dotta/status/2045146539534827998)
...
Every single person will be managing a team of a dozen, or a hundred, or a thousand agents and Lovon Teams will be the default tool to manage it all.
