...
name: release
description: >
  Coordinate a full Lovon Teams release across engineering verification, npm,
...
Run the full Lovon Teams maintainer release workflow, not just an npm publish.
...
7. If running through Lovon Teams, you have issue context for status updates and follow-up task creation.
...
Lovon Teams now uses a commit-driven release model:
...
- release summary in Lovon Teams issue context
