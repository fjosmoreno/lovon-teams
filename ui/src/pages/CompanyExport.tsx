...
function generateReadmeFromSelection(
  ...
  lines.push("```");
  lines.push("");
  lines.push("See [Lovon Teams](https://paperclip.ing) for more information.");
  lines.push("");
  lines.push("---");
  lines.push(`Exported from [Lovon Teams](https://paperclip.ing) on ${new Date().toISOString().split("T")[0]}`);
  lines.push("");
