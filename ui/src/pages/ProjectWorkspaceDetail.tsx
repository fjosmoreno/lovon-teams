...
const SOURCE_TYPE_OPTIONS: Array<{ value: ProjectWorkspaceSourceType; label: string; description: string }> = [
  { value: "local_path", label: "Local git checkout", description: "A local path Lovon Teams can use directly." },
        ...
        <div className="space-y-6">
          <div className="rounded-2xl border border-border bg-card p-5">
            <p className="max-w-2xl text-sm text-muted-foreground">
              Configure the concrete workspace Lovon Teams attaches to this project. These values drive per-workspace
            ...
            <div className="mt-4 grid gap-4">
              ...
              <details className="rounded-xl border border-dashed border-border/70 bg-background px-3 py-3">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Lovon Teams derives Services and Jobs from this JSON. Prefer editing named commands first; use raw JSON for advanced lifecycle, port, readiness, or environment settings.
                </p>
                <div className="mt-3">
