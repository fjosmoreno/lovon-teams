...
export function CliAuthPage() {
    ...
    return (
      <div className="mx-auto max-w-xl py-10">
        <div className="rounded-lg border border-border bg-card p-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            The Lovon CLI can now finish authentication on the requesting machine.
          </p>
  ...
  return (
    <div className="mx-auto max-w-xl py-10">
      <div className="rounded-lg border border-border bg-card p-6">
        <h1 className="text-xl font-semibold">Approve Lovon CLI access</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          A local Lovon CLI process is requesting board access to this instance.
        </p>
