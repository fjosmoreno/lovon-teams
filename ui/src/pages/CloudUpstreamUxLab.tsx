      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="space-y-1">
          ...
          <p className="max-w-2xl text-sm text-muted-foreground">
            Push {selectedCompanyName} into a Lovon Teams Cloud stack. Automations stay paused until activation.
          </p>
        </div>
          ...
          {connection ? (
            ...
            <div className="grid gap-3 md:grid-cols-[1fr_auto]">
              <Input
                ...
                aria-label="Lovon Teams Cloud stack URL"
                autoFocus
              />
              <Button disabled>
...
const STACK_TARGET = {
  ...
  stackDisplayName: "Lovon Teams Prod",
  companyId: "co_4hT2yX",
...
function buildFixture(state: FixtureStateKey): Fixture {
  switch (state) {
    case "settings-pane":
      return {
        selectedCompanyName: "Lovon Teams · PC521D",
